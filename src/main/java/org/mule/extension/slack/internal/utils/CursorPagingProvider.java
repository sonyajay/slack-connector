...
public class CursorPagingProvider implements PagingProvider<SlackConnection, Map<String, Object>> {
    ...
    public CursorPagingProvider(BiFunction<SlackConnection, String, CompletableFuture<HttpResponse>> futureFunction, String payloadExpression, ExpressionManager expressionManager) {
    ...
    public List<Map<String, Object>> getPage(SlackConnection connection) {
        ...
        HttpResponseConsumer<List<Map<String, Object>>, Map<String, Object>> consumer = new HttpResponseConsumer<>(payloadExpression, "#[output application/java --- payload.response_metadata]", CHANNEL_LISTING, new CompletionCallback<List<Map<String, Object>>, Map<String, Object>>() {
            @Override
        ...
        nextCursor = (String) resultReference.get().getAttributes().get().get("next_cursor");
